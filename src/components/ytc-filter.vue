        ...
        <div v-show="displayOptions" class="vc-options">
          <div class="vc-options-item">
            ...
            <label for="height-opt" class="flex-align-center">
              Height: <input type="range" id="height-opt" class="width" min="50" :max="maxHeight" :disabled="this.options.autoMaxHeight" v-model="options.height" step="1" /> Auto
              max height:<input id="max-height-opt" type="checkbox" v-model="options.autoMaxHeight" />
            </label>
            <span>{{ heightPx }}</span>
          </div>
          <div class="vc-options-item">
